...
export default function Creators() {
  ...
  return (
    <div className='max-w-screen-xl px-6 py-10 mx-auto py-32 relative overflow-hidden' ref={creator}>
      ...
      <div className="contents">
        <div className='flex flex-col items-center z-20 mb-24 -translate-y-10 relative'>
          <span className='font-bold text-h'>Enjoy listening to endless</span>
          <span className='font-bold mb-10 text-h'>stories with your creators</span>
        </div>
