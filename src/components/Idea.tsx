   ...
   return (
      <div id="idea-section">
         <div className='py-10 bg-gray-200 w-full'>
            <div className="idea-wrapper flex items-center justify-center ">
               <div className="image-container bg-center bg-no-repeat bg-cover" style={{ backgroundImage: `url(${require('../assets/images/frame_bg.webp')})` }}>
                  ...
                  <div className="icon-list rounded-lg bg-white p-3 inline-flex flex-col gap-4">
