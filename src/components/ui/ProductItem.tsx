...
export default function ProductItem({ img }: { img: string }) {
   return (
      <div className='product-card w-52 h-36 p-4 bg-center bg-no-repeat bg-cover rounded-2xl flex flex-col' style={{ backgroundImage: `url(${require(`../../assets/images/${img}`)})` }}>
         <div className='badge'>
