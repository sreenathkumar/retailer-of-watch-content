...
export default function TestmonialCard() {
    return (
        <div className='flex flex-col rounded-md px-6 py-10 border-2 border-gray-400'>
            ...
            <div>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus doloribus sunt officia aliquid eos voluptate, natus id odit rem illo. Necessitatibus reprehenderit dolores voluptatum molestias provident voluptatibus ab consequatur rerum?</p>
            </div>
        </div>
    )
}
